...
period = 1.0
incl = 70
path = os.path.join(cwd, "BetaLyrae1070")
try:
    os.mkdir(path)
except:
    print("Klasor zaten var")

arraySma = np.linspace(5, 15, 20)
arrayQ = np.linspace(0.6, 0.8, 20)
arrayTeffP = np.linspace(7000, 7900, 20)
arrayTeffS = np.linspace(4500, 5500, 20)
        ...
        for teffP in arrayTeffP:
            for teffS in arrayTeffS:
                ...
                try:
                    ...
                    print("Şu parametrelerle sentetik Beta Lyrae Light Curve oluşturulamadı: count:" 
