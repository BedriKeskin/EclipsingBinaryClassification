...
period = 0.4
incl = 70
path = os.path.join(cwd, "WUMa0470")
try:
    os.mkdir(path)
except:
    print("Klasor zaten var")

arraySma = np.linspace(3.3, 3.9, 20)
arrayQ = np.linspace(0.7, 0.9, 20)
arrayTeffP = np.linspace(7500, 7950, 20)
arrayTeffS = np.linspace(7350, 7450, 20)
        ...
        for teffP in arrayTeffP:
            for teffS in arrayTeffS:
                ...
                try:
                    ...
                    print("Su parametrelerle sentetik W Uma Light Curve olusturulamadı: count:" 
