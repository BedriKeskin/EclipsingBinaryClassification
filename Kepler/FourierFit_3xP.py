...
for index, LCdata in enumerate(LCdatas):
    ...
    try:
        ...
        ts_folded = timeSeries.fold(period=phaseFold*P * u.day, epoch_time=T0)
        ...
        xdata = phaseFold * xdata / (-xdata[0] * 2)
...
df.to_csv('FourierCoeffs_Kepler_'+str(phaseFold)+'xP.csv', index=False)
