...
#SBATCH -J GetGaiaDR3LCParamsAndData        # Gonderilen isin ismi
#SBATCH -o GetGaiaDR3LCParamsAndData.out    # Ciktinin yazilacagi dosya adi
...
python GetGaiaDR3LCParamsAndData.py
